...
import SteaAssistantLauncher from "./components/SteaAssistantLauncher.jsx";
...
function WebsiteCard({ w }) {
  ...
  return (
    ...
    >
      <div style={{ position: "relative", aspectRatio: "16/9", background: "rgba(255,255,255,.03)", overflow: "hidden" }}>
        {w.image || w.imageUrl ? (
          <img
          ...
          <div style={{ width: "100%", height: "100%", display: "grid", placeItems: "center", fontSize: 40, opacity: 0.2 }}>🌐</div>
        )}
      </div>
...
function WebsitesPage() {
  ...
  return (
    <section style={{ padding: isMobile ? "100px 0 24px 0" : "140px 0 40px 0" }}>
      <W>
        <SHead
...
export default function App() {
  ...
  useEffect(() => {
    const handleAppInstalled = () => {
      console.log('STEA App installed successfully!');
      ...
      if (u) {
        ...
        if (db) {
          try {
            ...
            console.log("[DEBUG] Auth user UID:", u.uid);
            console.log("[DEBUG] Auth user Email:", u.email);
            if (s.exists()) {
              const data = s.data();
              console.log("[DEBUG] Fetched Firestore user doc:", data);
              ...
              console.log("[DEBUG] Loaded role:", role, "Sector:", data.sector);
              extraData = {
                ...data,
              ...
              console.log("[DEBUG] Firestore user document does not exist for UID:", u.uid);
            }
          } catch (e) {
        ...
        >
          ...
          <main style={{ paddingBottom: isMobile ? 80 : 0 }}>
            <Routes>
              ...
              <Route path="/exams/abroad" element={<AbroadMoneyGuidePage />} />
