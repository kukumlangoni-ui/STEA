...
// ── WEBSITE SOLUTIONS ─────────────────────────────────
// Category → subcategory map (matches admin)
...
function WebsiteCard({ w }) {
  ...
  const hasImg = (w.imageUrl || w.image) && !imgErr;
...
function WebsitesPage() {
  ...
  return (
    <section style={{ padding: isMobile ? "clamp(72px,12vw,100px) 0 60px" : "140px 0 60px", minHeight: "100vh", background: "#06080f" }}>
      <W>
        {/* Header */}
