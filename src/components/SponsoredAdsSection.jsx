            ...
            >
              ...
              >
                ...
                <div style={{ 
                  flex: 1, 
                  minWidth: 0, 
                  padding: isMobile ? "20px" : "24px 32px 24px 0",
                  display: "flex",
                  flexDirection: "column",
                  ...
                  <div style={{ marginBottom: 12 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
                       <span style={{ background: "rgba(245, 166, 35, 0.15)", color: "#F5A623", fontSize: 10, padding: "3px 10px", borderRadius: 6, textTransform: "uppercase", fontWeight: 900, letterSpacing: "0.5px" }}>
                        Sponsored
                      </span>
                      {ad.clientName && (
                  ...
                  <div style={{ display: "flex", alignItems: "center" }}>
                    ...
                    >
                      {ad.ctaText || "Learn More"} <ExternalLink size={16} />
                    </div>
                  </div>
                </div>
              </div>
