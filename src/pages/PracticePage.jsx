...
export default function PracticePage() {
  ...
  const [leaderboard] = useState([
    { rank: 1, name: "Amina J.", score: 980, quizzes: 18, badge: "🏆" },
    { rank: 2, name: "David M.", score: 940, quizzes: 15, badge: "🥈" },
    { rank: 3, name: "Fatuma K.", score: 910, quizzes: 14, badge: "🥉" },
    { rank: 4, name: "Hassan L.", score: 870, quizzes: 12, badge: "⭐" },
    { rank: 5, name: "Neema P.", score: 830, quizzes: 11, badge: "⭐" },
    { rank: 6, name: "Baraka S.", score: 790, quizzes: 10, badge: "⭐" },
    { rank: 7, name: "Wema T.", score: 750, quizzes: 9, badge: "⭐" },
  ]);

  const DAILY_QUIZ = QUIZZES[new Date().getDay() % QUIZZES.length];
  const WEEKLY_CHALLENGE = QUIZZES[(new Date().getDay() + 2) % QUIZZES.length];
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "clamp(28px,5vw,48px) clamp(16px,4vw,40px)" }}>
        ...
        {activeTab === "leaderboard" && (
          <div>
            ...
            {/* Top 3 podium */}
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 12, marginBottom: 28, maxWidth: 520, margin: "0 auto 28px" }}>
