...
export default function StudentUpdatesPage() {
  ...
  // Load from Firestore — student updates & announcements only (no tech news)
  const { docs: updatesDocs, loading } = useCollection('updates', 'createdAt', 50);

  const allRemote = updatesDocs
