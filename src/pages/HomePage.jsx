...
export default function HomePage({ goPage, settings = {} }) {
  ...
  const { docs: updatesDocs, loading: updatesLoading } = useCollection("updates", "createdAt", 4);
  const { docs: postsDocs,   loading: postsLoading   } = useCollection("posts",   "createdAt", 4);
  const { docs: newsDocs,    loading: newsLoading     } = useCollection("news",    "createdAt", 3);
  ...
  }, [tips, tipsLoading, courses, coursesLoading, updates, updatesLoading, postsLoading, newsLoading]);
    ...
    <div style={{ minHeight: "100vh", background: "#04050a", color: "#fff", fontFamily: "'Instrument Sans',system-ui,sans-serif" }}>
      ...
      <section ref={heroRef} style={{
        ...
        <motion.div style={{ position: "relative", zIndex: 10, width: "100%", y: heroY, opacity: heroOp }}>
          <W>
            <div style={{ maxWidth: 780, paddingTop: isMobile ? "clamp(80px,20vw,120px)" : "clamp(100px,14vw,160px)", paddingBottom: isMobile ? "clamp(40px,8vw,60px)" : "clamp(60px,8vw,100px)" }}>
              ...
              <motion.p
                ...
                style={{ color: "rgba(255,255,255,.62)", fontSize: isMobile ? 15 : "clamp(15px,2vw,20px)", lineHeight: 1.65, maxWidth: 580, margin: "0 0 clamp(20px,3vw,40px)", fontWeight: 500 }}>
              ...
              <motion.div
                ...
                <GoldBtn onClick={() => goPage("courses")} style={{ fontSize: isMobile ? 15 : 16, padding: isMobile ? "13px 28px" : "15px 32px", width: isMobile ? "100%" : "auto", justifyContent: "center" }}>
              ...
              <motion.div
                ...
                style={{ display: "flex", alignItems: "center", gap: isMobile ? 20 : 28, marginTop: isMobile ? 20 : 44, flexWrap: "wrap" }}>
                {[
          ...
          <W>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "repeat(3, 1fr)", gap: isMobile ? 16 : 24 }}>
              {updates.map((u, i) => (
                ...
                >
                  {(u.imageUrl || u.image) && (
                    <div style={{ width: "100%", height: 160, overflow: "hidden", flexShrink: 0, background: "rgba(255,255,255,.04)" }}>
