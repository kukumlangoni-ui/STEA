...
// ── Tabs ─────────────────────────────────────────────
const TABS = [
  { id: "overview",     label: "Mwanzo",            emoji: "🌍" },
  { id: "scholarships", label: "Scholarships",       emoji: "🏆" },
  { id: "countries",    label: "Mataifa",             emoji: "🗺️" },
  { id: "requirements", label: "Mahitaji",            emoji: "📋" },
  { id: "steps",        label: "Hatua za Kuomba",    emoji: "📝" },
  { id: "agents",       label: "Wakala & Mashirika", emoji: "🤝" },
        ...
        <W>
          ...
          <motion.div initial={{ opacity: 0, y: 22 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: .5 }}>
            ...
            <div style={{ display: "flex", gap: 12, justifyContent: "center", flexWrap: "wrap" }}>
              {[["8+", "Scholarships"], ["6+", "Mataifa"], ["7", "Hatua"], ["Bure", "Mwongozo"]].map(([n, l]) => (
              ...
              <motion.div key="overview" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(240px,1fr))", gap: 16, marginBottom: 40 }}>
                  {[
                    ...
                    { emoji: "📝", title: "Hatua za Kuomba", desc: "Mwongozo wa hatua kwa hatua", tab_id: "steps", color: "#a855f7" },
