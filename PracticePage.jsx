...
import {
  ...
  Eye, Banknote, Smartphone, Building2, Users,
...
const COUNTRIES = [
  { flag:"🇨🇳", name:"China", color:RED, active:true, badge:"Inaendelea",
    ...
    note:"China ina mfumo tofauti wa malipo. Alipay na WeChat Pay zinatawala. Zinahitaji setup maalum.",
  ...
  { flag:"🇦🇪", name:"UAE / Dubai", color:"#f59e0b", active:false,
    ...
    note:"PayPal, bank transfer, na njia maalum za UAE zinafaa zaidi.",
    cta:"Inakuja Hivi Karibuni" },
  { flag:"🇮🇳", name:"India", color:"#f97316", active:false,
    desc:"Mwongozo wa kutuma pesa India — chaguzi nyingi za UPI, IMPS, na njia za kimataifa.",
  ...
  { flag:"🌍", name:"Nchi Nyingine", color:BLUE, active:false,
    desc:"Kwa nchi nyingine — Ulaya, Amerika, Australia, Canada na zaidi — wasiliana nasi kwa msaada maalum.",
...
const STEPS = [
  ...
  { icon:<Banknote size={24}/>,   color:G,      num:"02", title:"Chagua Njia ya Kutuma",         desc:"Kulingana na nchi na kiasi, chagua njia inayofaa — PayPal, benki, Alipay, au wakala." },
  ...
  { icon:<TrendingUp size={24}/>, color:PURPLE, num:"04", title:"Angalia Rate na Gharama",       desc:"Tafuta rate ya sasa ya ubadilishaji na gharama zote kabla ya kutuma — usishtuke baadaye." },
...
const PROBLEMS = [
  ...
  { icon:"🔒", title:"Vikwazo vya Akaunti",       desc:"PayPal na njia nyingine wakati mwingine zinashikilia pesa kwa sababu za usalama. Hii inaweza kusababisha msongo." },
...
const SAFETY_TIPS = [
  "Thibitisha jina na akaunti ya mpokeaji kabla ya kutuma",
  "Tumia njia zilizothibitishwa na zinazojulikana",
...
const FAQS = [
  { q:"Ni njia gani salama ya kutuma pesa China?", a:"China ni maalum sana — Alipay na WeChat Pay ndio njia zinazotawala. Bank transfer pia inaweza kufanya kazi lakini inachukua muda. Njia sahihi inategemea hali yako. Wasiliana na STEA kwa msaada maalum wa China." },
  { q:"PayPal na Alipay zinatofautianaje?", a:"PayPal ni ya kimataifa na inafanya kazi nchi nyingi lakini ina vikwazo China. Alipay ni ya China haswa na inahitaji setup maalum. Kwa kutuma pesa China, Alipay au njia mbadala za China zinafaa zaidi." },
  { q:"Je, STEA inatuma pesa moja kwa moja?", a:"Hapana. STEA haitoi huduma za kutuma pesa moja kwa moja kwa sasa. STEA ni mwongozo, msaada, na unganisho na njia salama au watu wa kuaminika. Tunakusaidia kuelewa na kufanya maamuzi sahihi." },
  ...
  { q:"Nawezaje kuepuka ulaghai wa kutuma pesa?", a:"Kamwe usitumie mtu usiyemjua. Thibitisha maelezo ya mpokeaji kabla ya kutuma. Epuka deals za rate nzuri kupita kiasi — mara nyingi ni ulaghai. STEA inakusaidia kutambua njia za kweli na salama." },
];
      ...
      <section style={{ padding:"100px 20px 80px", position:"relative", overflow:"hidden",
        ...
        <motion.div initial={{ opacity:0, y:28 }} animate={{ opacity:1, y:0 }} transition={{ duration:.5 }}>
          ...
          <p style={{ color:"rgba(255,255,255,.6)", maxWidth:560, margin:"0 auto 42px", fontSize:17, lineHeight:1.75 }}>
            Jifunze njia salama za kutuma pesa kwa wanafunzi, ndugu, jamaa na marafiki walioko nje ya nchi.
          </p>
        ...
        <W>
          <div style={{ textAlign:"center", marginBottom:52 }}>
            ...
            <p style={{ color:"rgba(255,255,255,.5)", fontSize:16, maxWidth:500, margin:"0 auto" }}>
              Kila nchi ina njia zake bora. Tunaanza na China — na tunakuwa tunaongeza nchi zaidi.
            </p>
          </div>
          ...
          <motion.div initial={{ opacity:0, y:16 }} whileInView={{ opacity:1, y:0 }} viewport={{ once:true }} transition={{ delay:.2 }}
            ...
            <div>
              ...
              <p style={{ fontSize:14, color:"rgba(255,255,255,.6)", lineHeight:1.65, margin:0 }}>
                China ina mfumo wa malipo tofauti kabisa — Alipay na WeChat Pay zinatawala, na zinahitaji setup maalum.
          ...
          <div style={{ background:CARD, border:`1px solid ${BORDER}`, borderRadius:22, padding:"clamp(28px,4vw,44px)", display:"flex", gap:24, alignItems:"flex-start", flexWrap:"wrap" }}>
            ...
            <div style={{ flex:1, minWidth:240 }}>
              ...
              <p style={{ fontSize:15, color:"rgba(255,255,255,.6)", lineHeight:1.75, marginBottom:20 }}>
                Rate hubadilika kila saa kulingana na soko la fedha duniani. Inategemea njia unayotumia, kiasi cha pesa, na nchi unayotuma. Usitegemee rate ya jana — angalia siku unayotuma.
              </p>
        ...
        <W>
          <div style={{ background:`linear-gradient(135deg, rgba(245,166,35,.1), rgba(245,166,35,.03))`, border:"1px solid rgba(245,166,35,.22)", borderRadius:24, padding:"clamp(32px,5vw,56px)", textAlign:"center" }}>
            ...
            <p style={{ color:"rgba(255,255,255,.6)", maxWidth:480, margin:"0 auto 36px", fontSize:16, lineHeight:1.7 }}>
              STEA inatoa mwongozo, ushauri, na msaada wa kuunganisha watu na njia salama kwa mahitaji ya kutuma pesa kimataifa.
            </p>
          ...
          <div style={{ background:"rgba(255,255,255,.02)", border:`1px solid ${BORDER}`, borderRadius:20, padding:"28px 32px", display:"flex", gap:18, alignItems:"flex-start", flexWrap:"wrap" }}>
            ...
            <div style={{ flex:1, minWidth:240 }}>
              ...
              <p style={{ fontSize:14, color:"rgba(255,255,255,.5)", lineHeight:1.8, margin:0 }}>
                <strong style={{ color:"#fff" }}>STEA haitoi huduma za kifedha moja kwa moja kwa sasa.</strong> Tunatoa mwongozo, ushauri, na msaada wa mawasiliano ya kuaminika kulingana na mahitaji ya mtumiaji.
                Tafadhali zingatia sheria za nchi yako na uthibitishe maelezo yote kabla ya kufanya muamala wowote wa kifedha.
              </p>
            </div>
          </div>
        </W>
